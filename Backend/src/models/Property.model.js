...
const propertySchema = new Schema({
  ...
  user_id: { type: Schema.Types.ObjectId, ref: 'users', required: true, index: true }, // Relación con el usuario creador
...
// Middleware para popular el campo `user_id` automáticamente en las consultas
propertySchema.pre('find', function() {
  this.populate('user_id', 'name email'); // Popula el campo `user_id` con los campos `name` y `email`
});
